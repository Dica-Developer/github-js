...
define(function(){
     ...
     **/
    authorization.authorization.prototype.getAll = function(msg, block, callback) {
        var self = this;
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    authorization.authorization.prototype.get = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    authorization.authorization.prototype.create = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    authorization.authorization.prototype.update = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    authorization.authorization.prototype.delete = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
