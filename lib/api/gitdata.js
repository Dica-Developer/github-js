...
define(function(){
     ...
     **/
    gitdata.gitdata.getBlob = function(msg, block, callback) {
        var self = this;
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.createBlob = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.getCommit = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.createCommit = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.getReference = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.getAllReferences = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.createReference = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.updateReference = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.deleteReference = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.getTag = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.createTag = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.getTree = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
     ...
     *  @param {Function} callback function to call when the request is finished with an error as first argument and result data as second argument.
     **/
    gitdata.gitdata.createTree = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err) {
                return self.sendError(err, null, msg, callback);
