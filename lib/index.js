...
/**
 *  @overview
 *  @copyrigth Copyright 2012 Cloud9 IDE, Inc.
 *
 ...
 *
 */
define(['util', 'HttpError', 'api/index'],
    /**
     * @exports Client
     * @requires Util
     * @requires HttpError
     */
        function (util, HttpError, Api) {
        'use strict';
         ...
         *  @property {String} type One of the following: `basic` or `oauth`
         *  @property {String} username Github username
         *  @property {String} password Password to your account
         ...
         *  });
         *  @param {authConfig} authConfig Object containing the authentication type and credentials
         **/
